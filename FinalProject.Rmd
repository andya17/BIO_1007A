...
---
```
4. For the posts I added, I used what the theme guide [calls a Jekyll Helper](https://mmistakes.github.io/minimal-mistakes/docs/helpers/).
...
```
* I referred to the path of the image by putting /assets/ before the file name, and I also used the formatting of {% %} which is present on the theme guide. This allowed a picture to be inserted in-line with a caption underneath.
...
main:
  ...
  #   url: https://mmistakes.github.io/minimal-mistakes/about/
   - title: "Tree Photos"
     url: /treephotos/
```
4. Pages you add in this way should show up on the navigation bar on the top of your website.
...
For the February academic calendar post, I used the feature of adding text to specific days. 

```{r warning=FALSE}
feb23academic <- calendR(
                    year=2023, # Specify a year and month.
                    month=2,
                    title="February 2023 Academic Calendar", 
                    title.col="white", # Change the color of the title.
                    weeknames=c("M", "T", "W", "R", "F", "Sa", "Su"), # You can change teh day abbreviations to be shorter.
                    start="M", # I can start on Monday as I have put Monday first in my weeknames list.
                    lty=1, # This adds a line between days on the calendar.
                    col="black", # This changes the line color (added with lty) to black.
                    days.col="black", # This changes the color of the day numbers on the calendar.
                    weeknames.col="white", # This changes the color of the day abbreviations above the days.
                    special.days="weekend", # You have the choice of specifying "weekend" to automatically give all Saturdays and Sundays a color instead of using the vector method I used last time.
                    special.col="skyblue", # Weekend days will be sky blue.
                    text=c("BIOL 1007", "ECSC 350\nBIOL 211", "MUSC 101\nGEOG 310\nLab", "ECSC 350\nBIOL 211\nLab", "MUSC 101\nGEOG 310"), # Specify text that you want to show on the days. This only works for monthly calendars. Use \n to show multiple things, in this case classes, per day.
                    text.pos=c(c(2), c(13,17,20,24,27), c(14,21,28), c(15,22), c(16,23)), # I specified five options for text in the above argument. This means that I must add five days or sets of days, one corresponding to each string of text. For example, "BIOL 1007" only needs to appear on the 2nd of February, but I have the schedule specified by the second option on five days total. This will require using c() inside c().
                    text.size=2.75, # You can knit and adjust text size to see if your text fits within the confines of the days.
                    text.col="black", # This changes the color of the text added on days.
                    bg.col="midnightblue", # This adds a full background of midnight blue to the final product.
                    font.family="serif", # This changes the font family.
                    font.style="bold"
                    )
...
academicYear <- calendR(
        ...
        doc_name = "calendR-year-2023") # This will be the name of the PDF that shows up in the folder. You can't use the same name if you've already knitted before and a PDF was created.
