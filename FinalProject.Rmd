...
academicYear <- calendR(
        ...
        doc_name = "calendR-year-2023-final") # This will be the name of the PDF that shows up in the folder. You can't use the same name if you've already knitted before and a PDF was created.
