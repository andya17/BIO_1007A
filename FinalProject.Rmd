...
```
* I referred to the path of the image by putting /assets/ before the file name, and I also used the formatting which is present on the theme guide. This allowed a picture to be inserted in-line with a caption underneath.
